const Landing = () => {
  return (
    <div className="w-screen h-[100vh] bg-gradient-to-b from-[#462b9c] to-[#644ab5] flex justify-center items-center">
      <div className="h-[70vh] md:h-[60vh] w-[90vw] flex flex-col justify-between items-center">
